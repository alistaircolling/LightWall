...
public class DropsRan extends ExtraWindow {

	public float yCount;
	public float totWidth = 40;
	public float speed = 10;
	public float totHeight = 25;
	public float inc;
	...
	public DropsRan(PApplet theApplet, String theName, int theWidth,
			int theHeight) {
